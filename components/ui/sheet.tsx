...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay ref={ref} className={cn("fixed inset-0 z-50 bg-background/85 backdrop-blur-sm", className)} {...props} />
));
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 gap-4 border-border bg-[hsl(var(--background))] p-6 shadow-2xl transition ease-in-out",
